...
const testimonials = [
  { name: "Komal Jadhav", role: "Manager, CMS Info Systems", text: "Vivek's commitment was exceptional. He consistently delivered with sharp UI decisions and rock-solid development.", imgPath: "/images/testimonials/komal.png", order: 0 },
  { name: "Mahesh Pathak", role: "CEO, Oneture Technologies", text: "His ability to adapt, lead, and deliver high-quality solutions across technologies made him one of our most valued engineers.", imgPath: "/images/testimonials/mahesh.jpg", order: 1 },
  { name: "Ravi Mevcha", role: "CTO, Oneture Technologies", text: "Vivek took full ownership of both UI and backend for our DaaS platform. His speed and quality under pressure were impressive.", imgPath: "/images/testimonials/ravi.jpg", order: 2 },
  ...
  { name: "Tsurov Magomet", role: "Automotive Photographer, tsurov.com", text: "Vivek is simply the best developer I've worked with. He built my entire visual portfolio platform and podcast studio booking site from scratch — complete with admin panels, SEO, and stunning design. He understood my creative vision perfectly and delivered beyond what I imagined.", imgPath: "/images/testimonials/tsurov.jpg", order: 7 },
];
