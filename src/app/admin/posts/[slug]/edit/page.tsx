...
export default function EditPostPage({
  ...
  async function handleSave() {
    ...
    try {
      ...
      // If slug changed, redirect to new edit page
      if (form.slug !== slug) {
    ...
    <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-bold">Edit Post</h1>
            <p className="text-white/40 text-sm mt-0.5 font-mono">{slug}</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={deleting}
            className="flex items-center gap-2 px-3 py-2 text-sm text-red-400/70 hover:text-red-400 border border-red-500/10 rounded-lg hover:bg-red-500/10 transition-colors disabled:opacity-50"
          >
            {deleting ? (
